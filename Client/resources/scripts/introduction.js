...
{
    fadeTextOne();
    setTimeout(fadeOutTextOne, 10000);
    setTimeout(fadeTextTwo, 16000);
    setTimeout(fadeOutTextTwo, 26000);
    setTimeout(fadeTextThree, 32000)
    setTimeout(fadeOutTextThree, 42000)
    setTimeout(fadeTextTitle, 47000)
}
...
function fadeTextThree()
{
    ...
    textBox.width =
    textBox.placeholder = "Tell us their name if you know it"
    textBox.id = "NameBox";
