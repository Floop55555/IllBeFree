let puzzleInputList = [0,0,0,0,0,0,0,0,0]
const puzzleSolutionList = [1,1,1,1,0,1,1,1,1]
const puzzleKeyList = [3,-1,1,1,-1,3,-1,3,-1,1,1,-1,3,-1]
let puzzle1= new Puzzle(2,3,3,puzzleSolutionList,puzzleKeyList);
function onLoad(){
setUpPuzzle();
// startTimer();
};
